...
const TabsTrigger = React.forwardRef<React.ElementRef<typeof TabsPrimitive.Trigger>,
...
const TabsContent = React.forwardRef<React.ElementRef<typeof TabsPrimitive.Content>,
